...
public class Swagger2Config {
	...
	public Docket api()
	{
		return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.basePackage("com.example.demo.rest"))
	...
	private ApiInfo apiEndPointInfo() {
		...
		return new ApiInfoBuilder().title("SpringBoot Rest Api")
				.description("Instructor Management Rest Apo")
